...
<script type="text/javascript" src="<c:url value='/' />/assets/js/jquery/jquery-1.9.0.js"></script>
	...
	<div id="container">
		...
		<div id="content">
			<div id="user">
				...
				<form id="join-form" name="joinForm" method="post" action="<c:url value='/' />/user/join">
